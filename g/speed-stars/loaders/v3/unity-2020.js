! function(n) {
  ...
  var i = {
    ...
    maxRatio: 16 / 9,
    minRatio: 9 / 16,
    thumbnail: "./cdn-cgi/image/a398cd4e645b76810031bd97f8697414.png",
    numScreenshots: 4,
  ...
  var m, p, g, w, v, y, b = t(10),
    ...
    C = window.location.hostname.endsWith(window.location.hostname) || window.location.hostname.endsWith(".poki-gdn.com"),
